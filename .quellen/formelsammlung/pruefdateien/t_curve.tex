...
\noindent\begin{tikzpicture}[scale=0.80]
  ...
  \node[white,anchor=east] at (4.60,1.72) {$p\cdot V=\mtxt{konst.}$};
  \node[white,anchor=east] at (4.60,1.22) {($T$ konstant)};
\end{tikzpicture}\par\vspace{4mm}
\noindent\begin{tikzpicture}[scale=0.80]
  \draw[ax] (0,0)--(4.70,0) node[below right]{$T$ [K]};
  \draw[ax] (0,0)--(0,2.05) node[left]{$p$ [Pa]};
  \draw[kurve] (0,0)--(4.40,1.65);
  \node[white,anchor=north west] at (0.12,2.10) {$\dfrac{p}{T}=\mtxt{konst.}$};
  \node[white,anchor=east] at (4.60,0.42) {($V$ konstant)};
...
\noindent\begin{tikzpicture}[scale=0.80]
  ...
  \draw[kurve] (0,0)--(4.40,1.65);
  \node[white,anchor=north west] at (0.12,2.10) {$\dfrac{V}{T}=\mtxt{konst.}$};
  \node[white,anchor=east] at (4.60,0.42) {($p$ konstant)};
  \fill[bern] (0,0) circle (1.2pt);
\end{tikzpicture}\par\vspace{4mm}
\end{document}