...
\noindent\begin{tikzpicture}[scale=0.95]
  \draw[white] (0.35,0)--(2.65,0);
  \draw[white] (2.65,0)--(2.65,0.52);
  \draw[white] (2.65,1.08)--(2.65,1.60);
  \draw[white] (2.65,1.60)--(0.35,1.60);
  \draw[white] (0.35,1.60)--(0.35,1.02);
  \draw[white] (0.35,0.58)--(0.35,0);
  \draw[white] (0.13,1.02)--(0.57,1.02);
  \draw[white] (0.23,0.58)--(0.47,0.58);
  \node[grau,right,inner sep=2pt] at (0.59,1.02) {\tiny$+$};
  \node[grau,right,inner sep=2pt] at (0.59,0.58) {\tiny$-$};
  \draw[white] (0.13,1.02)--(-0.22,1.02);
  \draw[white] (0.23,0.58)--(-0.22,0.58);
  \draw[white] (-0.16,1.02)--(-0.16,0.58);
  \node[bernm,left,inner sep=2pt] at (-0.20,0.80) {$U$};
  \draw[white] (2.29,0.52) rectangle (3.01,1.08);
  \node at (2.65,0.80) {$R$};
  \draw[white] (1.18,1.60)--(1.82,1.60);
  \node[bernm,above,inner sep=3pt] at (1.50,1.62) {$I$};
  \draw[white] (3.05,1.08)--(3.42,1.08);
  \draw[white] (3.05,0.52)--(3.42,0.52);
  \draw[white] (3.36,1.08)--(3.36,0.52);
  \node[bernm,right,inner sep=3pt] at (3.40,0.80) {$U$};
\end{tikzpicture}\par\vspace{6mm}
\noindent\begin{tikzpicture}[scale=0.80]
  \draw[white] (0,0)--(0,1.60)--(0.70,1.60);
  \draw[white] (0.70,1.42) rectangle (1.40,1.78); \node at (1.05,1.60) {$R_1$};
  \draw[white] (1.40,1.60)--(1.90,1.60);
  \draw[white] (1.90,1.42) rectangle (2.60,1.78); \node at (2.25,1.60) {$R_2$};
  \draw[white] (2.60,1.60)--(2.95,1.60);
  \foreach \x in {3.10,3.30,3.50}{\fill[white] (\x,1.60) circle (0.045);}
  \draw[white] (3.65,1.60)--(4.10,1.60)--(4.10,0)--(2.42,0);
  \draw[white] (1.92,0)--(0,0);
  \draw[white] (1.92,-0.22)--(1.92,0.22);
  \draw[white] (2.42,-0.12)--(2.42,0.12);
  \node[grau,above,inner sep=1pt] at (1.92,0.22) {\tiny$+$};
  \node[grau,above,inner sep=1pt] at (2.42,0.12) {\tiny$-$};
  \draw[white] (1.92,-0.22)--(1.92,-0.52);
  \draw[white] (2.42,-0.12)--(2.42,-0.52);
  \draw[white] (1.92,-0.46)--(2.42,-0.46);
  \node[bernm,below,inner sep=2pt] at (2.17,-0.50) {$U$};
  \draw[white] (0.18,1.60)--(0.58,1.60);
  \node[bernm,above,inner sep=2pt] at (0.38,1.62) {$I$};
  \draw[white] (0.70,1.42)--(0.70,1.02); \draw[white] (1.40,1.42)--(1.40,1.02);
  \draw[white] (0.70,1.02)--(1.40,1.02);
  \node[bernm,below,inner sep=2pt] at (1.05,1.00) {$U_1$};
  \draw[white] (1.90,1.42)--(1.90,1.02); \draw[white] (2.60,1.42)--(2.60,1.02);
  \draw[white] (1.90,1.02)--(2.60,1.02);
  \node[bernm,below,inner sep=2pt] at (2.25,1.00) {$U_2$};
\end{tikzpicture}\par\vspace{6mm}
\noindent\begin{tikzpicture}[scale=0.80]
  \draw[white] (0,1.70)--(0,1.06);
  \draw[white]   (-0.24,1.06)--(0.24,1.06);
  \draw[white] (-0.13,0.64)--(0.13,0.64);
  \draw[white] (0,0.64)--(0,0);
  \node[grau,right,inner sep=2pt] at (0.26,1.06) {\tiny$+$};
  \node[grau,right,inner sep=2pt] at (0.15,0.64) {\tiny$-$};
  \draw[white] (-0.24,1.06)--(-0.62,1.06);
  \draw[white] (-0.13,0.64)--(-0.62,0.64);
  \draw[white] (-0.56,1.06)--(-0.56,0.64);
  \node[bernm,left,inner sep=2pt] at (-0.60,0.85) {$U$};
  \draw[white] (0,1.70)--(3.55,1.70);
  \draw[white] (0,0)--(3.55,0);
  \draw[white] (0.35,1.70)--(0.80,1.70);
  \node[bernm,above,inner sep=2pt] at (0.58,1.72) {$I$};
  \draw[white] (1.30,1.70)--(1.30,1.15);
  \draw[white] (1.30,0.55)--(1.30,0);
  \draw[white] (0.95,0.55) rectangle (1.65,1.15); \node at (1.30,0.85) {$R_1$};
  \draw[white] (1.30,1.62)--(1.30,1.26);
  \node[bernm,left,inner sep=2pt] at (1.26,1.44) {$I_1$};
  \draw[white] (2.60,1.70)--(2.60,1.15);
  \draw[white] (2.60,0.55)--(2.60,0);
  \draw[white] (2.25,0.55) rectangle (2.95,1.15); \node at (2.60,0.85) {$R_2$};
  \draw[white] (2.60,1.62)--(2.60,1.26);
